...
var DOCENTES = [
  { nombre: "Yesica",      apellido: "VELAZQUEZ",        email: "yvelazquez@abc.gob.ar",  turno: "Mañana", grado: "1°", seccion: "A" },
  { nombre: "Maisa Elida", apellido: "BUDIÑO",           email: "maisabudino@abc.gob.ar", turno: "Mañana", grado: "2°", seccion: "A" },
  ...
  { nombre: "Pamela",      apellido: "FERREIRA DASILVA", email: "paferreira@abc.gob.ar",  turno: "Mañana", grado: "5°", seccion: "A" },
  { nombre: "Yesica",      apellido: "TILLERIA",         email: "yestilleria@abc.gob.ar", turno: "Mañana", grado: "6°", seccion: "A" },
  ...
  { nombre: "Veronica",    apellido: "DESTEFANO",        email: "vdestefano1@abc.gob.ar", turno: "Tarde",  grado: "6°", seccion: "B" },
  { nombre: "Lucia",       apellido: "PERUNETTE",        email: "luperunette@abc.gob.ar", turno: "Tarde",  grado: "1°", seccion: "A" }
];

var CRITERIOS = [
  { seccion: "Clima áulico", items: [
  ...
  { seccion: "Ambiente Alfabetizador", items: [
  ...
  { seccion: "Presentación de los contenidos", items: [
