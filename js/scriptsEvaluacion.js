...
function generarPreview() {
  ...
  pdfCache = html;
  PDFUtils.preview(html, 'pdfFrame');
}
...
function guardarPDF() {
  ...
  PDFUtils.descargar(pdfCache, 'evaluacion_' + d.apellido + '.pdf');
}
...
function _buildPDFHTML() {
  ...
  return (
    ...
    '.tit{font-size:17px;font-weight:800;background:linear-gradient(135deg,#667eea,#764ba2);-webkit-background-clip:text;-webkit-text-fill-color:transparent;}' +
    ...
    '.ebn{width:17px;height:17px;background:linear-gradient(135deg,#1e40af,#3b82f6);color:white;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:10px;font-weight:800;}' +
    'table{width:100%;border-collapse:collapse;margin-bottom:14px;border-radius:8px;overflow:hidden;box-shadow:0 1px 6px rgba(30,58,92,.08);}' +
    'table th{background:linear-gradient(135deg,#1e40af,#3b82f6);color:white;padding:7px;text-align:center;font-size:10px;font-weight:800;}' +
    'table th:first-child{text-align:left;padding-left:12px;}' +
    'table tr:nth-child(even){background:#f8fbff;}' +
    '.score{background:linear-gradient(135deg,#1e40af,#3b82f6);color:white;border-radius:8px;padding:10px 16px;text-align:center;font-weight:800;font-size:13px;margin-bottom:14px;}' +
    ...
    '.ft{background:linear-gradient(135deg,#1e40af,#3b82f6);color:white;font-weight:800;padding:5px 10px;font-size:10px;letter-spacing:.4px;}' +
